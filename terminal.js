function showHelp() {
    if (currentHost === 'jumphost') {
        ...
        addOutput('  help                // Global variables
var currentDir = '/root';
var commandHistory = [];
var historyIndex = -1;
...
var systemState = {
    centos: {
        ...
        packagesInstalled: falsefunction listFiles(args) {
...
function getPromptString() {
    switch(currentHost) {
        ...
        default: return 'training@jumphost:~
...
function updatePrompt() {
    ...
    switch(currentHost) {
        ...
        case 'k8s':
            ...
            break;
        default:
            statusElement.textContent = 'Connection: Local Training Environment';
    }
